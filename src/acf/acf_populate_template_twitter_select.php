 ...
 */
class acf_populate_template_twitter_select
{
    ...
    public function __construct(){
        add_action('acf/load_field/name=ppp_schedule_twitter_template', [$this,'populate']);
    }
    ...
    public function populate($field) {
        ...
        if (have_rows('ppp_templates', 'option')) {
            ...
            while (have_rows('ppp_templates', 'option')) {
                ...
                // we don't list instagram templates in the twitter
                // select list.
