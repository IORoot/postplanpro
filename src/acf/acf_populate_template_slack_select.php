 ...
 */
class acf_populate_template_slack_select
{

    public $platform = 'slack';


    public function __construct(){
        add_action('acf/load_field/name=ppp_schedule_slack_template', [$this,'populate']);
    }
    ...
    public function populate($field) {
        ...
        if (have_rows('ppp_templates', 'option')) {
            ...
            while (have_rows('ppp_templates', 'option')) {
                ...
                // we don't list instagram templates in the slack
                // select list.
